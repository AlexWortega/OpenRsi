...
Champion scaffold v0, mean geomean speedup: **0.079x**
Baseline (gen0): 0.079x  |  RSI delta: +0.000x

Edit mode: bounded  |  per-solve budget: 360min
Total OpenRouter cost: $28.14
