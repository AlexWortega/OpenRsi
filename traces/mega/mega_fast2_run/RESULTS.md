...
Champion scaffold v0, mean geomean speedup: **4.956x**
Baseline (gen0): 4.956x  |  RSI delta: +0.000x

Edit mode: bounded  |  per-solve budget: 90min
Total OpenRouter cost: $13.44
