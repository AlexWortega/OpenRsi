...
Champion scaffold v0, mean geomean speedup: **5.513x**
Baseline (gen0): 5.513x  |  RSI delta: +0.000x

Edit mode: bounded  |  per-solve budget: 180min
Total OpenRouter cost: $22.15
