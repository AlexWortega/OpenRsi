...
Champion scaffold v0, mean geomean speedup: **4.088x**
Baseline (gen0): 4.088x  |  RSI delta: +0.000x

Edit mode: bounded  |  per-solve budget: 450min
Total OpenRouter cost: $38.01
